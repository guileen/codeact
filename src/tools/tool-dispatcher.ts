...
export class ToolDispatcher {
   ...
   */
  async dispatch(toolName: string, toolParams: Record<string, any>): Promise<
    string | AsyncGenerator<string, void, unknown> | Generator<string, void, unknown>
  > {
   ...
   */
  private async *asyncStreamGenerator(asyncGen: AsyncGenerator<any, void, unknown>): AsyncGenerator<string, void, unknown> {
   ...
   */
  private *streamGenerator(syncGen: Generator<any, void, unknown>): Generator<string, void, unknown> {
