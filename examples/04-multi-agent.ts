...
async function runMultiAgentExample() {
  ...
  const weatherAgent = new LightAgent({
    name: 'WeatherAgent',
    instructions: 'You are a weather expert. Provide detailed weather information and climate-related insights.',
  ...
  const mathAgent = new LightAgent({
    name: 'MathAgent',
    instructions: 'You are a mathematics expert. Solve calculations and provide mathematical explanations.',
  ...
  const generalAgent = new LightAgent({
    name: 'GeneralAgent',
    instructions: 'You are a helpful general assistant. Handle various types of queries and coordinate with specialists when needed.',
